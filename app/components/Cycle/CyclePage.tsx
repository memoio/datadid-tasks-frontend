...
export const cards = [
    ...
    { id: 18, imgSrc: "/Cycle22.png", participants: 800, name: "AIDA", aliases: "AIDA", short: "AI-powered decentralized ecosystem for DeFi & AI", text: "AIDA is a decentralized ecosystem that combines DeFi and AI technologies, aiming to provide users with a range of AI-related cryptocurrency services." },
