  ...
  return (
    <div className="mt-[55px]">
      <div className="text-center">
        <h1
          className={`${paytoneOne.className} text-transparent bg-clip-text bg-gradient-to-b from-[#214177] to-[#05F292] text-[34px] md:text-[48px] font-bold`}
        >
          Activity Cycle
        </h1>
        <p className="text-white text-[16px] md:text-[24px] mt-3">
        ...
        <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-around items-center mt-[65px] gap-8 px-6 animate-fade-in bg-[#05F2920D] border-x-[3px] border-[#05F292] rounded-[10px] py-[20px]">
                {[
                    ...
                    { label: 'Total Points Earned', value: '800' },
                ].map((stat, i) => (
                    <div key={i}>
                        <div className="text-center">
