        ...
        <div className="animate-fade-in">
            ...
            <div className="w-full rounded-[10px] bg-gradient-to-br from-[#064E33] to-[#214177] mt-[25px] px-[25px] py-[30px] animate-card-load">
                <div className="flex items-center justify-between">
                    ...
                    {/* Right Section */}
                    <div
                        className="bg-[#05F292] rounded-[10px] text-[18px] font-bold text-center px-[25px] py-[20px] cursor-pointer hover:bg-[#04D582] hover:scale-105 transition-all duration-300">
                        Start To Earn
                    </div>
                </div>
            </div>
